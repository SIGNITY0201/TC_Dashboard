...
function sortConsRows() {
    ...
    rows.sort((a, b) => {
        ...
        const getPriority = (cat, name) => {
            if (name === "OASIS" || name === "New OASIS" || name === "Glass Sliding" || name === "Glass Folding" || name === "Fix Glass" || name === "스톤데크" || name === "Mirage" || name === "Zip Screen") return 1;
